(ns status-im.data-store-worker.realm.schemas.account.v21.core
  (:require [status-im.data-store-worker.realm.schemas.account.v21.chat :as chat]
            [status-im.data-store-worker.realm.schemas.account.v1.chat-contact :as chat-contact]
            [status-im.data-store-worker.realm.schemas.account.v19.contact :as contact]
            [status-im.data-store-worker.realm.schemas.account.v20.discover :as discover]
            [status-im.data-store-worker.realm.schemas.account.v19.message :as message]
            ...
            [status-im.data-store-worker.realm.schemas.account.v19.request :as request]
            [status-im.data-store-worker.realm.schemas.account.v19.user-status :as user-status]
            ...
            [status-im.data-store-worker.realm.schemas.account.v21.browser :as browser]
